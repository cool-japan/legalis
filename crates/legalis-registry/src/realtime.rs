...
impl ChangeSubscription {
    ...
    pub fn matches_statute(&self, statute_id: &str) -> bool {
        self.statute_filters.is_empty() || self.statute_filters.contains(&statute_id.to_string())
    }
...
mod tests {
    ...
    fn test_presence_tracker_users_for_statute() {
        ...
        let presence1 =
            UserPresence::new("user1".to_string()).with_current_statute("statute-1".to_string());
        let presence2 =
            UserPresence::new("user2".to_string()).with_current_statute("statute-2".to_string());
