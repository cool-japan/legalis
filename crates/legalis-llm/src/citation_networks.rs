...
impl CitationNetwork {
    ...
    pub fn add_citation(&mut self, citation: CaseCitation) -> Result<()> {
    ...
    pub fn get_outgoing_citations(&self, case_id: &str) -> Vec<&CaseCitation> {
        self.citations
            .iter()
    ...
    pub fn get_incoming_citations(&self, case_id: &str) -> Vec<&CaseCitation> {
        self.citations
            .iter()
...
mod tests {
    ...
    fn create_sample_network() -> CitationNetwork {
        ...
        network
            .add_citation(CaseCitation::new("case2", "case1", TreatmentType::Followed))
            .unwrap();
        network
            .add_citation(CaseCitation::new("case3", "case1", TreatmentType::Followed))
            .unwrap();
        network
            .add_citation(CaseCitation::new("case3", "case2", TreatmentType::Followed))
            .unwrap();
