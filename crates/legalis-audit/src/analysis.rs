...
mod tests {
    ...
    fn test_anomaly_detection() {
        ...
        // With 10 records spread across 20 buckets (avg 0.5 per bucket),
        // any bucket with 2+ records exceeds the 2x threshold.
        // We just verify the function runs without panic and returns valid results.
        for anomaly in &anomalies {
            assert!(anomaly.count > anomaly.expected);
        }
    }
}
