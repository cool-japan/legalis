...
`legalis-cli` provides a comprehensive command-line tool for working with legal statutes, including parsing, verification, visualization, simulation, and more.

## Installation

```bash
# From crates.io (when published)
cargo install legalis-cli
