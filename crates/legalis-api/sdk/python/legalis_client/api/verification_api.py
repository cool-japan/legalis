...
class VerificationApi:
    ...
    def verify_statutes(
        ...
        _param = self._verify_statutes_serialize(
    ...
    @validate_call
    def verify_statutes_with_http_info(
        self,
        verify_request: VerifyRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VerifyStatutes200Response]:
        """Verify statutes
    ...
    @validate_call
    def verify_statutes_without_preload_content(
        self,
        verify_request: VerifyRequest,
        _request_timeout: Union[
            None,
    ...
    def _verify_statutes_serialize(
        self,
        verify_request,
        _request_auth,
        _content_type,
