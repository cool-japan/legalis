...
class StatuteListResponseData(BaseModel):
    """
    StatuteListResponseData
    """ # noqa: E501
    statutes: Optional[List[StatuteSummary]] = None
    __properties: ClassVar[List[str]] = ["statutes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statutes": [StatuteSummary.from_dict(_item) for _item in obj["statutes"]] if obj.get("statutes") is not None else None
        })
        return _obj
