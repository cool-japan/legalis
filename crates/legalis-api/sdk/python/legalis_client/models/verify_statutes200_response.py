...
class VerifyStatutes200Response(BaseModel):
    """
    VerifyStatutes200Response
    """ # noqa: E501
    data: Optional[VerifyResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": VerifyResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
